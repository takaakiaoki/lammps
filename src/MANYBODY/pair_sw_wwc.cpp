...
Takaaki AOKI (Kyoto Univ. for Weaklime, Wu, Carter, Si-F extention
------------------------------------------------------------------------- */
...
PairSWWWC::PairSWWWC(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 0;
  restartinfo = 0;
  one_coeff = 1;
...
void PairSWWWC::compute(int eflag, int vflag)
{
...
void PairSWWWC::settings(int narg, char **arg)
{
...
void PairSWWWC::coeff(int narg, char **arg)
{
  int i,j,n;
...
double PairSWWWC::init_one(int i, int j)
{
...
void PairSWWWC::read_file(char *file)
{
...
void PairSWWWC::twobody(Param *param, double rsq, double &fforce,
...
void PairSWWWC::threebody(Param *paramij, Param *paramik, Param *paramijk,
